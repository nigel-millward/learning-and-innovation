...
This module covers:
- An overview of Python scope
- The LEGB rule explained
- Local vs Global scope
- Enclosing scope
- Modifying variables across scopes (global and nonlocal)
"""


# =========================================
# 1.1 Python Scope overview
# =========================================
"""
In Python, scopes determine the visibility and lifetime of your variables
by following a strict lookup order called the LEGB rule, which stands for
...
# =========================================
# 1.3 Local vs Global scope example
# =========================================
...
# =========================================
# 1.5 Modifying variables across scopes
# =========================================
"""
