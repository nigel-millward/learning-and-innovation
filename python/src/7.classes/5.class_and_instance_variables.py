...
# 5. Direct modification can break invariants
...
# 6. Users can add new attributes dynamically
...
# 7. Explicit self improves readability
...
# 8. self is just a naming convention
...
# 10. Methods can call other methods via self
...
# 11. Methods can access global names
...
# 12. Every value is an object with a class
