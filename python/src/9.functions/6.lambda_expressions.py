...
This module covers:
- Writing a lambda compared to a regular function
- When to use lambdas (sorting, filtering, mapping)
- Golden rules for keeping them readable
"""
...
# =========================================
"""
The same logic written as a lambda expression.
"""
...
# =========================================
# 1.3 When Do You Use Lambda Functions?
# =========================================
"""
...
# =========================================
"""
Use a lambda as the key function to control how items are sorted.
"""
...
# =========================================
"""
Use a lambda with filter() to keep only items that match a condition.
"""
...
# =========================================
"""
Use a lambda with map() to apply a function to every item in an iterable.
"""
