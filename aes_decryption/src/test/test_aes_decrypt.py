...
class TestAES(unittest.TestCase):
    ...
    def test_aes_decrypt_base_64_string(self):
        ...
        # ACT
        decrypted_text = decrypt_string_by_encode_type(base64_encrypted_text, 'base64')

        # ASSERT
        self.assertEquals(decrypted_text, plain_text)
    ...
    def test_aes_decrypt_hex_string(self):
        ...
        # ACT
        decrypted_text = decrypt_string_by_encode_type(base64_encrypted_text, 'hex')
